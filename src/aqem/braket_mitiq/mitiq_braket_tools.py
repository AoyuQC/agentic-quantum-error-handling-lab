...
#
# Vendored from amazon-braket-examples (examples/error_mitigation/on_mitiq/
# mitiq_braket_tools.py) under the Apache License, Version 2.0. See the NOTICE
# file at the repository root for attribution.
#
# Adaptation: the original used a sys.path hack plus `from tools.mitigation_tools
# import process_readout_twirl`; here it is a package-relative import.
...
from .mitigation_tools import process_readout_twirl
