...
#
# Vendored verbatim from amazon-braket-examples (examples/error_mitigation/
# tools/noise_models.py) under the Apache License, Version 2.0. See the NOTICE
# file at the repository root for attribution.
#
# Provides ready-made local density-matrix simulators with named noise models:
#   qd_readout    — symmetric readout bit-flip noise
#   qd_readout_2  — asymmetric per-qubit readout noise (readout-dominated)
#   qd_depol      — gate depolarizing noise
#   qd_total      — combined gate + readout noise
#   qd_amp        — two-qubit amplitude damping
